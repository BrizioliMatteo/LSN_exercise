...
Epot = np.loadtxt("Instant/output_epot_liquid.dat", usecols=(0), unpack='true')
Ekin = np.loadtxt("Instant/output_ekin_liquid.dat", usecols=(0), unpack='true')
Etot = np.loadtxt("Instant/output_etot_liquid.dat", usecols=(0), unpack='true')
Temp = np.loadtxt("Instant/output_temp_liquid.dat", usecols=(0), unpack='true')
Pres = np.loadtxt("Instant/output_pres_liquid.dat", usecols=(0), unpack='true')
